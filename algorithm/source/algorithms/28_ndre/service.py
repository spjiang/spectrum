...
async def run(*, file: UploadFile, file2: UploadFile | None, params_json: str):
    ...
    return ok_response(
        ...
        files={"ndre_npy": str(npy_path.resolve()), "preview_png": str(png_path.resolve())},
    )
