...
PARAM_HELP = {
    ...
    "solar_zenith": "太阳天顶角（度）；默认 30 不是现场角",
    "view_zenith": "观测天顶角（度）；天底为 0",
    "relative_azimuth": "太阳与观测的相对方位角（度）",
    "n_lai": "叶面积查找表有几档（默认 25）",
    "n_cab": "叶绿素查找表有几档（默认 16）",
    "best_frac": "平均代价最好的表行比例（默认 0.05）",
    "cost_method": "比像不像的尺子：rmse 或 sam",
    "panel_reflectance": "参考板反射率",
    "model": "分类器 svm 或 rf",
    "kernel": "SVM 核函数",
    "n_estimators": "随机森林树数",
    "tile_size": "分块边长（像元）",
    "tile_rows": "正射按多少行一块计算",
    "workers": "并行线程数（0 表示按 CPU 核数）",
    "gsd_out": "正射输出地面采样距离（米）；不填则按航高推算",
...
METHODS = {
    ...
    "33_physical_inversion": "PROSAIL LUT（RMSE + 多解平均）",
    ...
    "46_reci": "RECI = NIR/RE − 1",
    "47_gndvi": "GNDVI = (NIR-GREEN)/(NIR+GREEN)",
    "48_osavi": "OSAVI = (NIR-RED)/(NIR+RED+0.16)",
    "49_arvi": "ARVI = (NIR-RB)/(NIR+RB)",
    "50_vari": "VARI = (GREEN-RED)/(GREEN+RED-BLUE)",
    "51_lai_index": "经验 LAI = max(3.618×EVI − 0.118, 0)",
    "52_nbr": "NBR = (NIR-SWIR)/(NIR+SWIR)",
    "53_sipi": "SIPI = (NIR-BLUE)/(NIR-RED)",
    "54_gci": "GCI = NIR/GREEN − 1",
    "55_ndsi": "NDSI = (GREEN-SWIR)/(GREEN+SWIR)",
}
...
COMPARE = {
    ...
    "46_reci": "cube_to_product",
    "47_gndvi": "cube_to_product",
    "48_osavi": "cube_to_product",
    "49_arvi": "cube_to_product",
    "50_vari": "cube_to_product",
    "51_lai_index": "cube_to_product",
    "52_nbr": "cube_to_product",
    "53_sipi": "cube_to_product",
    "54_gci": "cube_to_product",
    "55_ndsi": "cube_to_product",
}
...
OUTPUT_VIS = {
    ...
    "evi_tif": ("raster_index", "EVI 专题图"),
    "savi_tif": ("raster_index", "SAVI 专题图"),
    "msavi_tif": ("raster_index", "MSAVI 专题图"),
    "ndmi_tif": ("raster_index", "NDMI 专题图"),
    "ndwi_tif": ("raster_index", "NDWI 专题图"),
    "mndwi_tif": ("raster_index", "MNDWI 专题图"),
    ...
    "lai_index_tif": ("raster_index", "经验叶面积指数"),
    "reci_tif": ("raster_index", "RECI 专题图"),
    "gndvi_tif": ("raster_index", "GNDVI 专题图"),
    "osavi_tif": ("raster_index", "OSAVI 专题图"),
    "arvi_tif": ("raster_index", "ARVI 专题图"),
    "vari_tif": ("raster_index", "VARI 专题图"),
    "nbr_tif": ("raster_index", "NBR 专题图"),
    "sipi_tif": ("raster_index", "SIPI 专题图"),
    "gci_tif": ("raster_index", "GCI 专题图"),
    "ndsi_tif": ("raster_index", "NDSI 专题图"),
...
def _output_fields(algorithm_id: str, doc_output: str) -> list[dict]:
    ...
    keys = {
        ...
        "29_evi_savi": ["evi_tif", "savi_tif", "msavi_tif", "preview_png"],
        "30_ndmi_ndwi": ["ndmi_tif", "ndwi_tif", "mndwi_tif", "preview_png"],
        ...
        "46_reci": ["reci_tif", "preview_png"],
        "47_gndvi": ["gndvi_tif", "preview_png"],
        "48_osavi": ["osavi_tif", "preview_png"],
        "49_arvi": ["arvi_tif", "preview_png"],
        "50_vari": ["vari_tif", "preview_png"],
        "51_lai_index": ["lai_index_tif", "preview_png"],
        "52_nbr": ["nbr_tif", "preview_png"],
        "53_sipi": ["sipi_tif", "preview_png"],
        "54_gci": ["gci_tif", "preview_png"],
        "55_ndsi": ["ndsi_tif", "preview_png"],
    }.get(algorithm_id, [])
