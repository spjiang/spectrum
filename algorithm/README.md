...
| [docs/采集到算法-算法清单.md](./docs/采集到算法-算法清单.md) | **业界算法清单（55 项）**：先 L0–L4 架构图，再按层级列算法（作用/场景/输入/输出） |
| [docs/参考链接算法分析.md](./docs/参考链接算法分析.md) | 对 `dev.prompt.md` 两篇链接中算法的拆解（植被指数已分析；知乎文待补正文） |
| [docs/高光谱算法体系-培训汇报.pptx](./docs/高光谱算法体系-培训汇报.pptx) | **培训/汇报 PPT**：架构 L0–L4、55 算法简介、服务对接 |
| [docs/高光谱算法体系-v4.pptx](./docs/高光谱算法体系-v4.pptx) | 政企蓝培训 PPT v4（72 页，55 项） |
| [docs/55项算法科学证据审查报告.md](./docs/55项算法科学证据审查报告.md) | 55 项科学证据等级与边界 |
| [docs/高光谱55项算法能力与服务封装方案.docx](./docs/高光谱55项算法能力与服务封装方案.docx) | 能力与服务封装 Word |
| [docs/generate_training_ppt.py](./docs/generate_training_ppt.py) | PPT 生成脚本（可按清单更新后重跑） |
| [docs/算法API测试清单.md](./docs/算法API测试清单.md) | **55 算法 curl 测试清单**（含算法介绍，对齐清单） |
...
| [source/README.md](./source/README.md) | **算法 HTTP API（单服务）**：55 算法分目录；**GeoTIFF 等业界格式**入出 |
