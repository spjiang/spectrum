    ...
    *,
    ...
    try:
        ...
        result = run_mosaic(
            ...
            benchmark_dir=Path(params["benchmark_dir"]) if params.get("benchmark_dir") else None,
            match_reference_color=bool(params.get("match_reference_color")),
            reporter=reporter,
            control=control,
            start_stage=start,
